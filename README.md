...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-server-fixtures-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11511&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-server-fixtures-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-server-fixtures` can be installed with:

```
conda install pytest-server-fixtures
```

It is possible to list all of the versions of `pytest-server-fixtures` available on your platform with:
